# Responses, strings, text for module music_library.childes.user_library
...
inline_data = get_child_modules_settings_inline_data(
    module_path=bot_path.BOT_DIR / "modules" / Path("music_library/childes/user_library/childes"),
    root_package="app.bot.modules.music_library.childes.user_library.childes",
