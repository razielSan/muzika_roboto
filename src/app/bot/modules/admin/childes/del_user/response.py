# Responses, strings, text for module admin.childes.del_user
...
inline_data = get_child_modules_settings_inline_data(
    module_path=bot_path.BOT_DIR / "modules" / Path("admin/childes/del_user/childes"),
    root_package="app.bot.modules.admin.childes.del_user.childes",
