# Responses, strings, text for module admin.childes.base_music
...
inline_data = get_child_modules_settings_inline_data(
    module_path=bot_path.BOT_DIR / "modules" / Path("admin/childes/base_music/childes"),
    root_package="app.bot.modules.admin.childes.base_music.childes",
