# Responses, strings, text for module admin.childes.add_executor
...
inline_data = get_child_modules_settings_inline_data(
    module_path=bot_path.BOT_DIR / "modules" / Path("admin/childes/add_executor/childes"),
    root_package="app.bot.modules.admin.childes.add_executor.childes",
